...
package myportfolioapp.shared.generated.resources
...
internal object Res {
    ...
    public suspend fun readBytes(path: String): ByteArray =
        readResourceBytes("composeResources/myportfolioapp.shared.generated.resources/" + path)
    ...
    public fun getUri(path: String): String =
        getResourceUri("composeResources/myportfolioapp.shared.generated.resources/" + path)
